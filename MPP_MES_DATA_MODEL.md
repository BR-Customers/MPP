...
**Version:** v1.9 working draft (rev 2026-06-04n — sub-LOT split relocated from Trim OUT to **Machining OUT** per FDS v1.3 / Phased Plan v1.1; `Parts.OperationTemplate.RequiresSubLotSplit` now controls the Machining OUT outbound flow (FDS-05-009), and the ALTER lands in Phase 5 migration `0018` rather than Phase 4 `0017`. v1.9m (2026-04-29) had added the column under the prior Trim-OUT design. See revision history.)
**Schemas:** 8 | **Tables:** ~73
