...
- **Still owed before merge:** Designer reload-from-disk + smoke of the TrimBody / group-1 view edits + `scan.ps1`; **re-seed** (`Seed-SmokeData.ps1`) + **gateway restart** (the suite reset `MPP_MES_Dev`).
