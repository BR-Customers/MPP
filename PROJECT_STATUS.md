...
- **OI-35 still gates the actual SQL build** — the task list assumes the Phase 0 default decisions (closure table, monthly partitioning, materialized columns, OperationLog split); these must be ratified in Phase 0 before Phase 1 (`0019`) is written.
