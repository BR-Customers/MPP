...
**Last updated:** 2026-07-06 — **Spec 2 (machining/assembly plant-floor flow reconciliation) EXECUTED end-to-end on `jacques/working`. All SQL built + verified (full suite 1910/1910 green, only the pre-existing `010_Parts_codes_crud` thrower); Ignition backend + views file-authored + scanned. A4 (serialized FG-LOT) deferred by decision; M3 view-repoint deferred. Awaiting Jacques's Designer smoke of the views. See the 2026-07-06 section directly below.** Prior header note (2026-07-02):
