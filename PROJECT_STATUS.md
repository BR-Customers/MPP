...
**Last updated:** 2026-09-11 (afternoon) — **Open boxes belong to a station (migration `0078`): METTs A and B can run the same part numbers at once, and each can switch between part boxes.**
