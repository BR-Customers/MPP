...
BEGIN
    ...
    SELECT de.Id                    AS DowntimeEventId,
           ...
           COALESCE(de.DurationMinutes, CASE WHEN de.EndedAt IS NULL THEN NULL ELSE DATEDIFF(MINUTE, de.StartedAt, de.EndedAt) END) AS DurationMinutes,
           de.IsApproximate         AS IsApproximate,
