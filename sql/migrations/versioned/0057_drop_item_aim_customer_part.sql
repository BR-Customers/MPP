-- =============================================
-- Migration:   0057_drop_item_aim_customer_part.sql
...
IF NOT EXISTS (SELECT 1 FROM dbo.SchemaVersion WHERE MigrationId = N'0057_drop_item_aim_customer_part')
    INSERT INTO dbo.SchemaVersion (MigrationId, Description)
    VALUES (N'0057_drop_item_aim_customer_part',
