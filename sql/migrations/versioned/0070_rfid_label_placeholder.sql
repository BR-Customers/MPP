-- =============================================
-- Migration:   0070_rfid_label_placeholder.sql
...
IF NOT EXISTS (SELECT 1 FROM dbo.SchemaVersion WHERE MigrationId = N'0070_rfid_label_placeholder')
    INSERT INTO dbo.SchemaVersion (MigrationId, Description)
    VALUES (N'0070_rfid_label_placeholder',
...
PRINT 'Migration 0070 (rfid_label_placeholder) applied.';
GO
