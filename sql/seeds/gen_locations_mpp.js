...
// MPP ships 14 parts it does not manufacture in Madison. They are real shippable
...
offsite.forEach(([partNumber, lineCode, lineName, closure], i) => {
  ...
  // Feed the shared attribute path rather than emitting attrs here, so these
  // terminals go through exactly the same DefaultScreen / closure / scanner
  // emission as every Site-derived terminal below.
